...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bUseAllowedTag_MetaData[];
#endif
		static void NewProp_bUseAllowedTag_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bUseAllowedTag;
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseTagQuery_MetaData[] = {
		{ "Category", "Condition" },
		{ "Comment", "// if we use tag query to check if we should perform the action? False will use simple tag check.\n" },
		{ "ModuleRelativePath", "Public/Features/EquipmentFeature_ConditionalBase.h" },
		{ "ToolTip", "if we use tag query to check if we should perform the action? False will use simple tag check." },
	};
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag_MetaData[] = {
		{ "Category", "Condition" },
		{ "Comment", "// If we use Allowed Tag to check if we should perform the action? False will considered as we always matched all allowed tags.\n" },
		{ "InlineEditConditionToggle", "" },
		{ "ModuleRelativePath", "Public/Features/EquipmentFeature_ConditionalBase.h" },
		{ "ToolTip", "If we use Allowed Tag to check if we should perform the action? False will considered as we always matched all allowed tags." },
	};
#endif
	void Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag_SetBit(void* Obj)
	{
		((UEquipmentFeature_ConditionalBase*)Obj)->bUseAllowedTag = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag = { "bUseAllowedTag", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UEquipmentFeature_ConditionalBase), &Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_AllowedTags_MetaData[] = {
		{ "Category", "Condition" },
		{ "Comment", "// Allowed tags, must match all tags in the container to perform the action.\n" },
		{ "EditCondition", "bUseAllowedTag" },
		{ "ModuleRelativePath", "Public/Features/EquipmentFeature_ConditionalBase.h" },
		{ "ToolTip", "Allowed tags, must match all tags in the container to perform the action." },
	};
#endif
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEquipmentFeature_ConditionalBase_Statics::NewProp_bUseAllowedTag,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginProject_Plugins_CrystalPluginLibrary_EquipmentSystem_Source_EquipmentSystem_Public_Features_EquipmentFeature_ConditionalBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEquipmentFeature_ConditionalBase, UEquipmentFeature_ConditionalBase::StaticClass, TEXT("UEquipmentFeature_ConditionalBase"), &Z_Registration_Info_UClass_UEquipmentFeature_ConditionalBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEquipmentFeature_ConditionalBase), 1874449248U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginProject_Plugins_CrystalPluginLibrary_EquipmentSystem_Source_EquipmentSystem_Public_Features_EquipmentFeature_ConditionalBase_h_738688757(TEXT("/Script/EquipmentSystem"),
